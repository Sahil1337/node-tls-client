...
export type h2SettingKeys = "HEADER_TABLE_SIZE" | "ENABLE_PUSH" | "MAX_CONCURRENT_STREAMS" | "INITIAL_WINDOW_SIZE" | "MAX_FRAME_SIZE" | "MAX_HEADER_LIST_SIZE";
...
export type supportedVersions = Partial<"GREASE" | "1.3" | "1.2" | "1.1" | "1.0">;
export type keyShareCurves = Partial<"GREASE" | "P256" | "P384" | "P521" | "X25519" | "P256Kyber768" | "X25519Kyber512D" | "X25519Kyber768">;
...
export type pseudoHeaderOrder = Partial<":method" | ":authority" | ":scheme" | ":path">;
export type methods = Partial<"GET" | "POST" | "PUT" | "DELETE" | "PATCH" | "OPTIONS" | "HEAD">;
